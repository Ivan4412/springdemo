...
public class TestActiviti {
    ...
    public void createTable(){
        ...
        processEngineConfiguration.setJdbcUrl("jdbc:mysql://localhost:3306/ivan?useUnicode=true&characterEncoding=utf8");
        processEngineConfiguration.setJdbcUsername("root");
        processEngineConfiguration.setJdbcPassword("imcoming4412");
